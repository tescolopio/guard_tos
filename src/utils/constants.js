...
const EXT_CONSTANTS = {
  ...
  ANALYSIS: {
    ...
    GRADES: {
      "A+": { MIN: 97, LABEL: "Exceptional" },
      A: { MIN: 93, LABEL: "Excellent" },
      "A-": { MIN: 90, LABEL: "Excellent" },
      "B+": { MIN: 87, LABEL: "Very Good" },
      B: { MIN: 83, LABEL: "Good" },
      "B-": { MIN: 80, LABEL: "Good" },
      "C+": { MIN: 77, LABEL: "Above Average" },
      C: { MIN: 73, LABEL: "Fair" },
      "C-": { MIN: 70, LABEL: "Fair" },
      "D+": { MIN: 67, LABEL: "Below Average" },
      D: { MIN: 63, LABEL: "Poor" },
      "D-": { MIN: 60, LABEL: "Poor" },
      "F+": { MIN: 50, LABEL: "Very Poor" },
      F: { MIN: 30, LABEL: "Failing" },
    ...
    RIGHTS: {
      ...
      GRADING: {
        // Map numeric score (0-100) to letter grade with plus/minus modifiers
        "A+": { MIN: 97 },
        A: { MIN: 93 },
        "A-": { MIN: 90 },
        "B+": { MIN: 87 },
