...
// Export the legalTerms array for use in other scripts
if (typeof window !== 'undefined') {
    window.legalTerms = legalTerms;
}

// Export the legalTerms array for use in Node.js environment
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { legalTerms };}

// Export the legalTerms array for use in ES6 modules
export { legalTerms };
